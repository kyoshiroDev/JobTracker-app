...
import { CandidatureDetailContentComponent } from "./candidature-detail-content/candidature-detail-content.component";
...
@Component({
  ...
  imports: [CommonModule, CandidatureDetailHeaderComponent, CandidatureDetailContentComponent, CandidatureDetailFooterComponent],
  template: `
    <div class="flex flex-col max-h-content justify-center items-center">
      ...
      >
        ...
        <fdw-candidature-detail-header (onClickReturn)="returnListeAnnonce()" class="text-JobTracker-white" [annonce]="annonce()" />
